"""
Refactored Dashboard with Clean Architecture
        ...
        <div class="grid two">
            <div class="card">
                ...
                <table>
                    ...
                    <tbody>{''.join(application_row(app) for app in recent_applications)}</tbody>
                </table>
            </div>
            <div class="card">
                <h2>Recent Jobs</h2>
                <table>
                    ...
                    <tbody>{''.join(job_row(job) for job in recent_jobs)}</tbody>
                </table>
            </div>
        </div>"""
        ...
        <div class="card ai-card">
            ...
            <div class="grid grid-3">
                <div>
                    ...
                    {"".join(strategy_recommendation(rec) for rec in market_recs)}
                </div>
                <div>
                    <h3>Application Strategy</h3>
                    {"".join(strategy_recommendation(rec) for rec in app_recs)}
                </div>
                <div>
